\begin{resumo}
    ...
    \palavrasChave{téléphonie sur IP; voix sur IP; codecs; framing; VAD; Cisco; opérateur; ospf; VPN; VLAN; liaisons synchrones; rapport signal/bruit; valence; horloges électroniques; fibres; réflectomètre; longeur d'onde; Python; interface graphique; grammaire; TOEIC; séries de Fourier; signaux périodiques}\end{resumo}